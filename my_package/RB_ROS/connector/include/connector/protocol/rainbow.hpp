#ifndef CONNECTOR_PROTOCOL_RAINBOW_HPP
#define CONNECTOR_PROTOCOL_RAINBOW_HPP
...
{
public:
    void set_mSTAT(const mSTAT& mSTAT) { mSTAT_ = mSTAT; }
    const mSTAT& get_mSTAT() const { return mSTAT_; }

    void set_systemSTAT(const systemSTAT& systemSTAT) { systemSTAT_ = systemSTAT; }
    const systemSTAT& get_systemSTAT() const { return systemSTAT_; }

    void set_systemCONFIG(const systemCONFIG& systemCONFIG) { systemCONFIG_ = systemCONFIG; }
    const systemCONFIG& get_systemCONFIG() const { return systemCONFIG_; }

    void set_systemPOPUP(const systemPOPUP& systemPOPUP) { systemPOPUP_ = systemPOPUP; }
    const systemPOPUP& get_systemPOPUP() const { return systemPOPUP_; }

    void set_systemGeneralCommand(const systemGeneralCommand& systemGeneralCommand) { systemGeneralCommand_ = systemGeneralCommand; }
    const systemGeneralCommand& get_systemGeneralCommand() const { return systemGeneralCommand_; }
...
private:
    ...
    systemGeneralCommand systemGeneralCommand_;
};
...
#endif // CONNECTOR_PROTOCOL_RAINBOW_HPP
